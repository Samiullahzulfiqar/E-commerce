...
<?php 
		...
		echo "<a href='http://www.SAMIULLAH.com/myshop/customer/my_account.php'>Go to your Account</a>";
		
		}
		else {
		
		echo "<h2>Welcome Guest, Payment was failed</h2><br>";
		echo "<a href='http://www.SAMIULLAH.com/myshop'>Go to Back to shop</a>";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website onlinetuting.com, please find your order details, your order will be processed shortly. Thank you!</p>
				...
				<h2> <a href='http://www.SAMIULLAH.com/myshop'>Click here</a> to login to your account</h2>
				
				<h3> Thank you for your order @ - www.SAMIULLAH.com</h3>
